...
<html >
 ...
 <script type="text/javascript" charset="utf8" src="/DataTables/datatables.js"></script>
    ...
    $('tablecmp').DataTable();
			...
			function buscarPersonal() 
        {
            ...
            if (textoBusqueda != "") 
            {
                ...
                $.post("alumnos/listarproveedor.php", {valorBusqueda: textoBusqueda}, function(mensaje) 
                {
	...
	$("#cargar_personal").load("alumnos/listarproveedor.php");
...
$("#btnUpdAlumno").click(function() {
    $.ajax({
        ...
        success: function(datos)
        {
            ...
            $("#le").load("alumnos/listarproveedor.php");
        }
    });
});
...
$("#btnDelAlumno").click(function() {
    ...
    <div class="welcome">
        ...
        <h1><center>Bienvenido, a consulta de proveedores</center></h1>
