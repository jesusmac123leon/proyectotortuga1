...
<html >
 ...
 <script type="text/javascript" charset="utf8" src="/DataTables/datatables.js"></script>
    ...
    $('tablecmp').DataTable();
			...
			function buscarPersonal() 
        {
            ...
            if (textoBusqueda != "") 
            {
                ...
                $.post("alumnos/listarmesa.php", {valorBusqueda: textoBusqueda}, function(mensaje) 
                {
	...
	$("#cargar_personal").load("alumnos/listarmesa.php");
            ...
            $("#critBPer").change(function()
            {
                ...
                {
                    $("#divInfo").hide();
                    $("#cargar_personal").load("listarproveedor.php");
                }
...
$("#btnUpdAlumno").click(function() {
    $.ajax({
        ...
        success: function(datos)
        {
            ...
            $("#le").load("alumnos/listarmesa.php");
        }
    });
});
...
$("#btnDelAlumno").click(function() {
    ...
    <div class="welcome">
        ...
        <h1><center>Bienvenido, a consulta de mesas</center></h1>
...
<div class="tab-pane fade in active" id="tab_per"><br>
		...
		<P><LABEL>id mesa: <INPUT type=number id="numControl" name="numControl" title="Ingrese Numero de Control" size="2" pattern="[0-9]" maxlenght="8" required="required"></LABEL>
		<P><LABEL>tipo de mesa :</LABEL><INPUT type=text id="nombre" name="nombre" size="21" pattern="[A-Za-z]{5,50}" title="Ingrese Nombre" maxlenght="50" required="required">
		<P><LABEL>num de silla :  </LABEL><INPUT type=number id="edad" name="edad"  min=1 max=99 size="12" maxlenght="2" title="Ingrese Edad" required="required">
		<P><LABEL>estado:  </LABEL><SELECT id="sexo" name="sexo" required="required" title="Seleccione Sexo">
			<OPTION>ocupado
			<OPTION> disponible
            
		</SELECT>
		<P><LABEL>numero de mesa : </LABEL><INPUT type=number id="telefono" name="telefono" pattern="[0-90-9]{9}" title="Ingrese Telefono" required="required">
