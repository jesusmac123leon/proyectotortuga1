...
<?php
    ...
    if (isset($_POST['valorBusqueda'])){
        ...
        $query = $conn->query("SELECT *FROM mesa");
        mostrar($conn,$query);
    }
			...
			<table id="tablecmp" class="table table-bordered">
                <thead>
                    <tr style="background-color: #f5f5f5">
                        <!--th>CUENTAS</th-->
                        <th><i class="fa fa-sort-alpha-asc" style="width: 16px"></i> id_mesa</th>
                        <th><i class="fa fa-user" style="width: 16px"></i> tipo de mesa </th>
                        <th><i class="fa fa-sitemap" style="width: 16px"></i> num de sillas</th>
						<th><i class="fa fa-institution" style="width: 16px"></i>estado</th>
                        <th><i class="fa fa-institution" style="width: 16px"></i>numero de mesa</th>
